...
# Check the weather on Hermosillo city
alias weather='curl wttr.in/Hermosillo'

# Colored ip command
alias ip='ip -c=auto'

# Auto verbose file commands
alias rm='rm -v'
alias mv='mv -v'
alias cp='cp -v'
...
alias zzz='sudo sleep'
alias bye='sudo poweroff'
alias cya='sudo reboot'
alias polygon='source .venv/bin/activate'
...
alias dumb='w3m https://dumb.ducks.party/'

export GOPATH=~/.go/bin
export PATH=/home/$USER/ICEbreaker/bin:$PATH
